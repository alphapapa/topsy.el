...
Run command ~topsy-mode~.  You may add it to appropriate hooks, such as
~prog-mode-hook~ and ~magit-section-mode-hook~.
...
#+begin_src emacs-lisp
  (defun my/topsy-elisp-header-line ()
  ...
  (cl-pushnew '(emacs-lisp-mode . my/topsy-elisp-header-line) topsy-mode-functions)
#+end_src
